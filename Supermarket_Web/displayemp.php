	...
	<div class="input-group">
  		...
  		<div class="column left">
	  		<div class="input-group">
                ...
                <button type="submit" name="customer" formaction="custom.php" class="btn">CUSTOMER</button><br/>
		...
		<div class="column middle">
			...
			<span style="padding-left:45px">Gender :
			    <span style="padding-left:0px"><input type="text" name="empgender" value="<?php echo $empgender; ?>"></span>
				<br><br/>
			...
			<span style="padding-left:45px">Type : 
			    <span style="padding-left:41px"><input type="text" name="jobtype" value="<?php echo $jobtype; ?>"></span>
				<br><br/>
			</span>
